...
def chat(request: ChatRequest):
    ...
    if 'top tse' in question or 'best tse' in question:
        ...
        result = df.pivot_table(index='TSE/Sales Man Name', columns='Month', values='Total', aggfunc='sum', fill_value=0)
        ...
        result = df.pivot_table(index='Department', columns='Month', values='Total', aggfunc='sum', fill_value=0)
        result['Total'] = result.sum(axis=1)
        result = result.sort_values('Total', ascending=False)
        result.columns.name = None
        ...
        result = df.pivot_table(index='Party Name', columns='Month', values='Total', aggfunc='sum', fill_value=0)
        result['Total'] = result.sum(axis=1)
